...
router.get("/",controls.getAllUsers); //Route to get all users from smart study system

router.get("/:id",controls.getUserById);  //Route to get a user by his id 

router.delete("/",controls.deleteAllUsers);// Route to delete all user from smart study

router.delete("/:id",controls.deleteUserById); // Route to delete a particular user in case the user voilates policy rules

router.post("/signup",authentication.register); // Route to register users in smart study
...
router.post("/signin", authChecker.checkUser, authentication.signIn); //Route to sign in user to his dashboard
